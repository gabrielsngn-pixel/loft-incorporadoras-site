...
const C = {
  orange: '#FF6600',
  orangeL: '#FF8533',
  orangeDim: 'rgba(255,102,0,0.08)',
  orangeGlow: 'rgba(255,102,0,0.20)',
      ...
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px', position: 'relative', zIndex: 10, width: '100%' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 72, alignItems: 'center' }}>
          ...
          >
            ...
            <motion.p
              variants={fadeUp}
              style={{ margin: 0, fontSize: 18, color: C.t2, lineHeight: 1.8, maxWidth: 460 }}
            >
            ...
            <motion.div
              variants={fadeUp}
              style={{ display: 'flex', gap: 28, paddingTop: 12, borderTop: `1px solid ${C.border}` }}
            >
              {[
                { v: '+R$10B', l: 'originados' },
                { v: '98%', l: 'aprovação' },
                { v: '15 dias', l: 'repasse médio' },
              ].map((s) => (
                <div key={s.v}>
                  <div style={{ fontSize: 21, fontWeight: 900, color: '#fff', letterSpacing: '-0.5px', ...SF }}>
                    {s.v}
                  </div>
                  <div style={{ fontSize: 11, color: C.t2, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.08em' }}>
                    {s.l}
                  </div>
                </div>
              ))}
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', borderBottom: `1px solid ${C.border}` }}>
                {[
                  ...
                  <div key={i} style={{ padding: '16px 18px', borderRight: i < 2 ? `1px solid ${C.border}` : 'none' }}>
                    <div style={{ fontSize: 10, color: C.t2, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: 4 }}>
                      {k.l}
                    </div>
                    <div style={{ fontSize: 20, fontWeight: 900, color: '#fff', letterSpacing: '-0.5px', ...SF }}>
                      {k.v}
                    </div>
                    <div style={{ fontSize: 11, fontWeight: 700, color: k.up ? C.green : C.orange, marginTop: 2 }}>
                      {k.d}
                    </div>
                  </div>
                ))}
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                  {events.map((ev, i) => (
                    ...
                    >
                      ...
                      <span style={{ fontSize: 11, fontWeight: 700, color: ev.color, whiteSpace: 'nowrap', marginLeft: 12 }}>
                        {ev.status}
                      </span>
                    </motion.div>
                  ))}
    ...
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 160px 1fr', alignItems: 'center', padding: '18px 0', borderBottom: `1px solid ${C.border}` }}>
      <div style={{ paddingRight: 24 }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
          ...
          <span style={{ fontSize: 16, fontWeight: 900, color: '#fff', ...SF }}>
            {beforeVal}
            {unit}
          </span>
        </div>
      ...
      <div style={{ paddingLeft: 24 }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
          ...
          <span style={{ fontSize: 16, fontWeight: 900, color: improved ? C.green : C.orange, ...SF }}>
            {afterVal}
            {unit}
          </span>
        </div>
      ...
      <div ref={ref} style={{ maxWidth: 1100, margin: '0 auto', position: 'relative', zIndex: 10 }}>
        <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} style={{ textAlign: 'center', marginBottom: 60 }}>
          ...
          <h2 style={{ fontSize: 50, fontWeight: 900, color: '#fff', margin: 0, letterSpacing: '-1.5px', ...SF }}>
            ...
            <br />
            <span style={{ color: C.orange }}>roda na infraestrutura Loft</span>
          </h2>
        ...
        >
          {[
            ...
            <div key={i} style={{ textAlign: 'center' }}>
              <div style={{ fontSize: 34, fontWeight: 900, color: C.orange, letterSpacing: '-1.5px', ...SF, lineHeight: 1 }}>
                {s.val}
              </div>
...
const OrbitalEcosystem = () => {
  ...
  const isSmall = typeof window !== 'undefined' ? window.innerWidth < 1200 : false;
  const R = Math.min(220, isSmall ? 160 : 220);
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', height: 'min(520px, 70vw)' }}>
            ...
            <div
              style={{
                ...
                height: R * 2 - 60,
                borderRadius: '50%',
                border: `1px dashed rgba(255,102,0,0.05)`,
                top: '50%',
                left: '50%',
                transform: 'translate(-50%,-50%)',
                pointerEvents: 'none',
            ...
            >
              ...
              <span style={{ fontSize: 8, color: 'rgba(255,255,255,0.65)', fontWeight: 700, letterSpacing: '0.15em', textTransform: 'uppercase', marginTop: 2 }}>
                OS
              </span>
            </motion.div>
                ...
                <React.Fragment key={mod.id}>
                  ...
                  >
                    ...
                    <div style={{ textAlign: 'center', lineHeight: 1.35 }}>
                      {mod.label.split('\n').map((ln, li) => (
                        <div key={li} style={{ fontSize: 11, fontWeight: 700, color: isActive ? '#fff' : C.t2, transition: 'color 0.2s', whiteSpace: 'nowrap' }}>
                          {ln}
                        </div>
                      ))}
                    </div>
            ...
            {[
              ...
              <motion.div
                ...
                style={{
                  padding: '18px',
                  borderRadius: 14,
                  gridColumn: s.span ? 'span 2' : 'auto',
                  background: s.hl ? C.orangeDim : C.s2,
                  border: `1px solid ${s.hl ? C.orangeBorder : C.border}`,
                  display: s.span ? 'flex' : 'block',
                  alignItems: 'center',
                  gap: 16,
                }}
              >
                <div style={{ fontSize: s.span ? 42 : 34, fontWeight: 900, color: s.hl ? C.orange : '#fff', ...SF, letterSpacing: '-1.5px', lineHeight: 1 }}>
                  {s.v}
                </div>
                <div style={{ fontSize: 12, color: s.hl ? C.orange : C.t2, marginTop: s.span ? 0 : 5, fontWeight: 600, lineHeight: 1.4 }}>
                  {s.l}
                </div>
              </motion.div>
            ))}
      ...
      <div style={{ maxWidth: 1280, margin: '0 auto', position: 'relative', zIndex: 10 }}>
        <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} style={{ textAlign: 'center', marginBottom: 80 }}>
          ...
          <h2 style={{ fontSize: 52, fontWeight: 900, color: '#fff', margin: 0, letterSpacing: '-1.5px', ...SF }}>
            Cada etapa coberta.
            <br />
            <span style={{ color: C.orange }}>Nenhuma fricção no meio.</span>
          </h2>
            ...
            {nodes.map((node, i) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    {node.label.split('\n').map((ln, li) => (
                      <div key={li} style={{ fontSize: 11, fontWeight: node.isLoft ? 800 : 700, color: node.isLoft ? C.orange : isActive ? '#fff' : C.t2, lineHeight: 1.4, transition: 'color 0.2s' }}>
                        {ln}
                      </div>
                    ))}
                  </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          {faqs.map((f, i) => (
            <motion.div
              ...
              style={{
                background: C.s1,
                border: `1px solid ${open === i ? C.borderB : C.border}`,
                borderRadius: 12,
                overflow: 'hidden',
                transition: 'border-color 0.2s',
              }}
